                ...
                <div class="signup-content">
                    <form action="" method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="username" id="name" placeholder="Your Name(Username)"/ required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="confirm_password" id="re_password" placeholder="Repeat your password"/ required>
                        </div>
                        <div class="form-group">
